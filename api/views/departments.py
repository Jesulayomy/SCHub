...
@app_views.route("/departments", methods=["GET", "POST"], strict_slashes=False)
...
def departments():
    ...
    if request.method == "GET":
        ...
        list_departments = [
            department.to_dict() for department in all_departments
        ]
        ...
        if "name" not in request.get_json():
            abort(400, description="Missing required parameter: name")
