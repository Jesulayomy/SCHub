...
class TestDepartmentDocs(unittest.TestCase):
    ...
    def test_pep8_conformance(self):
        ...
        for path in ['models/department.py',
    ...
    def test_module_docstring(self):
        ...
        self.assertIsNot(module_doc, None,
                         "department.py needs a docstring")
    ...
    def test_class_docstring(self):
        ...
        self.assertIsNot(Department.__doc__, None,
                         "Department class needs a docstring")
...
class TestDepartment(unittest.TestCase):
    ...
    def test_to_dict(self):
        ...
        self.assertIn(
                'id', sample_dict,
                "Object.to_dict() returns no 'id' attribute")
        self.assertIn(
                'created_at', sample_dict,
