...
class TestPersonDocs(unittest.TestCase):
    ...
    def test_pep8_conformance(self):
        ...
        for path in ["models/person.py", "tests/test_models/test_person.py"]:
    ...
    def test_module_docstring(self):
        ...
        self.assertIsNot(module_doc, None, "person.py needs a docstring")
        self.assertTrue(len(module_doc) > 1, "person.py needs a docstring")

    def test_class_docstring(self):
        """Test for the Person class docstring"""

        self.assertIsNot(Person.__doc__, None, "Person class needs a docstring")
        self.assertTrue(
            len(Person.__doc__) >= 1, "Person class needs a docstring"
        )
